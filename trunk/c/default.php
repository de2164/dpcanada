...
<?
echo sprintf( _("Distributed Proofreaders Canada (DPC) was founded in 2007 by Michael Shepard and David Jones to support the digitization of Public Domain books. Our inspiration was DP International, originally conceived to assist Project Gutenberg (PG). Just as Distributed Proofreaders (DP) is now the main source of PG e-books, we expect DPC to become the main source of e-books for <a href='http://www.gutenberg.ca'>Project Gutenberg Canada</a>(PGC) that started on July 1, 2007. All our proofreaders, managers, developers and so on are volunteers. The main principles of our mission are to: (1) preserve Canadiana, one page at a time, (2) take advantage of the favourable copyright laws in Canada to make books published after 1923, written by authors who died at least 50 years ago, more available to the public."), $PG_home_url );
echo "\n";
