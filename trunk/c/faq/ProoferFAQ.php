...
<table border="0" cellspacing="0" width="100%">
  <tbody>
    ...
    <tr>
      ...
      <ol>
        <li><a href="#1">What is Distributed Proofreaders Canada?                     </a></li>
        <li><a href="#2">What is Project Gutenberg Canada?                            </a></li>
...
<h3><a name="1">1. What is Distributed Proofreaders Canada? </a></h3>
Distributed Proofreaders Canada is an effort to support <a href="
<? echo $PG_home_url; ?>">Project Gutenberg Canada</a>. The basic concept is that our website software allows several
...
<ol compact>
  ...
  <li>When all the pages in a book have been proofread, a "post-processor" does the
      ...
      errors.
  <li>Finally the book is submitted to the Project Gutenberg Canada archive, and is posted on
      mirror sites all over the world, freely available for anyone to read and enjoy.
</ol>

<h3><a name="2">2. What is Project Gutenberg Canada? </a></h3>
...
<p> These Electronic Texts (E-texts) would be made available in the simplest, easiest to
    ...
    adavantage of Canada's more liberal copyright laws, and to preserve Canadiana.</p>
...
<p> The Project Managers pick whatever books we can find.  We
...
<p> In summary, <i>we do whatever books people provide to us (that we legally can).</i>
    ...
    Contact us at <a href="mailto:<? echo $general_help_email_addr; ?>">DPC Help</a>.
    or see the
    <a href="<? echo $forums_url ?>/viewforum.php?f=10">
    "Content Providers" Forum</a>. </p>

<h3><a name="4">4. How can I help? </a></h3>
<p> The process of creating an etext is a long one.</p>

<p>Distributed Proofreaders Canada was set up to make that go faster, by letting you help the
...
<p>If you really catch Distributed Proofreading Canada fever, you may want to <b>become a Project Manager</b>.
...
<p> There are no set "Rules" enforced by Project Gutenberg Canada, but in order to allow the
...
<p>Also, on the DPC main page, there is a weekly list of links to recent books completed
...
<p> You can go to Project Gutenberg Canada's <a
    href="<? echo $PG_catalog_url; ?>">online catalog</a> and get copies of any etext in
    the library, including the ones done through Distributed Proofreaders Canada. </p>
...
<p> The DPC site attempts to cooperate with firewalls, web caches and proxies, though if you see the
    <i>'I get the same page to proofread over and over again'</i> difficulty, please email us at <a href="mailto:<? echo $general_help_email_addr; ?>">DPC Help</a>, including your browser details.
    </p>
