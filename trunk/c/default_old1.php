...
<?
echo sprintf( _("Distributed Proofreaders Canada (DPC) was founded in 2007 by Michael Shepard and David Jones to support the digitization of Public Domain books. Our inspiration was DP International, originally conceived to assist Project Gutenberg (PG). Just as Distributed Proofreaders (DP) is now the main source of PG e-books, we expect DPC to become the main source of e-books for <a href='%s' target='_new'>Project Gutenberg Canada</a>(PGC) that started on July 1, 2007. All our proofreaders, managers, developers and so on are volunteers. The main principles of our mission are to: (1) preserve Canadiana, one page at a time, (2) take advantage of the favourable copyright laws in Canada to make books published after 1923, written by authors who died at least 50 years ago, more available to the public."), $PG_home_url );
echo "\n";
...
<? echo _("This site provides a web-based method of easing the proofreading work associated with the digitization of Public Domain books into Project Gutenberg Canada e-books. By breaking the work into individual pages many proofreaders can be working on the same book at the same time. This significantly speeds up the proofreading/e-book creation process."); ?></p>
...
<p><? echo _("Once all pages for a particular book have been processed, a post-processor joins the pieces, properly formats them into a Project Gutenberg Canada e-book, optionally makes it available to interested parties for 'smooth reading', and submits it to the PGC archive."); ?></p>
