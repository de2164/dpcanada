...
//MS echo "<form action='login.php' method='post'><input type='hidden' name='userNM' value='".$username."'><input type='password' name='userPW'><input type='submit' value='"._("Sign In")."'></form>";
echo "<form action='login.php' method='post'><input type='hidden' name='userNM' value='".$username."'><input type='hidden' name='destination' value='../tools/proofers/round.php?round_id=P1'><input type='password' name='userPW'><input type='submit' value='"._("Sign In")."'></form>";
