...
echo "<i>"._("Proofing Guidelines").":</i> ";
$url = "$code_url/faq2/".lang_dir().$round->document;
echo "<a style=\"color:#0000FF; text-decoration: underline;\" href='http://www.pgdpcanada.net/wiki/index.php?title=FAQ_Proofreading_Guidelines' target='_blank'>";
echo _('Guidelines');
echo "</a>\n";

echo "<i>"._("Formatting Guidelines").":</i> ";
$url = "$code_url/faq2/".lang_dir().$round->document;
echo "<a style=\"color:#0000FF; text-decoration: underline;\" href='http://www.pgdpcanada.net/wiki/index.php?title=Formatting_Guidelines' target='_blank'>";
echo _('Guidelines');
echo "</a>\n"; ?>
