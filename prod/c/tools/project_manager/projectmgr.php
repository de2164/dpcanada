...
echo "
    <div class='center'>
        <a href='{$pm_url}/show_image_sources.php'>Image Sources Info</a>
        |
        <a href='{$pm_url}/manage_image_sources.php"
                    ."?action=show_sources'>Manage Image Sources</a>
        |
        <a href='{$pm_url}/manage_image_sources.php"
                    ."?action=add_source'>Propose a new Image Source</a>
...
if($is_all) {
   echo "<a class='rfloat' href='{$pm_url}/projectmgr.php?show=user_active'>Show Only Active Projects</a>\n";
}
else {
    echo "<a class='rfloat' href='{$pm_url}/projectmgr.php?show=user_all'>Show All Projects</a>\n";
}
