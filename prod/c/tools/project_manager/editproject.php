...
class ProjectInfoHolder
{
    ...
    public function __construct($projectid) {
        ...
        $this->difficulty       = ( $username == "BEGIN" ? "Beginner" : "Average" );
        $this->image_source     = '_internal';
        $this->image_preparer   = $username;
        $this->text_preparer    = $username;
    }
...
// TODO not scannercredit below!
    ...
    public function show_form($project) {
        ...
        $this->row( _("Link to Source Images"),       'text_field',          $this->image_link);
