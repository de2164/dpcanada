...
describe the life of a Distributed Proofreaders Canada project up to the point
at which the image files and text files have been uploaded to the DPC
...
<ol>
<li><a name='create'><b>Create the project on the DPC website.</b></a>
    <blockquote>
	<p>
...
<li><a name='shepherd'><b>Shepherd the project through the site.</b></a>
    ...
    <p>
	If a proofer marks a page bad in P1 or P2, the project will stall until you
